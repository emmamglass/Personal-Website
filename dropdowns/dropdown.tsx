...
export const papinLab = () => {
  return (
    <div className={styles.dropdown}>
      ...
      <a href='/files/Ecological-Niche-Constrains-Evolution-of-Metabolic-Function-in-Pathobionts.pdf' target='_blank'>Abstract</a>
      <a href='https://github.com/emmamglass/PATHGENN' target='_blank'>View Source</a>
      ...
      <a href='/files/Metabolic-Analysis-of-the-Gardnerella-Pangenome-in-silico.pdf' target='_blank'>Abstract</a>
      <a href='https://github.com/emmamglass/Gardnerella_Pangenome' target='_blank'>View Source</a>
      ...
      <a href='https://github.com/emmamglass/reconstructor' target='_blank'>View Source</a>
      ...
      <a href='/files/Comparative-Genomics-and-Phenomics-Reveal-Genetic-and-Functional-Diversity-within-Pseudomonas-aeruginosa-Isolates.pdf' target='_blank'>Abstract</a>
    </div>
  )
}
...
export const raviLab = () => {
  return (
    <div className={styles.dropdown}>
      ...
      <a href='/files/fmedt-04-934015.pdf' target='_blank'>Paper</a>
      <a href='/files/BMES_Poster_2020-2.pdf' target='_blank'>Poster</a>
    </div>
  )
}
...
export const smithLab = () => {
  return (
    <div className={styles.dropdown}>
      ...
      <a href='/files/Research_Notes__CaMKII_Project.pdf' target='_blank'>Research Notes</a>
    </div>
  )
}
...
export const chitnisLab = () => {
  return (
    <div className={styles.dropdown}>
      ...
      <a href='/files/2018assipposterEmmaGlass.pdf' target='_blank'>Poster</a>
    </div>
  )
}
...
export const ferreriaLab = () => {
  return (
    <div className={styles.dropdown}>
      ...
      <a href='/files/Liminology-Oceanography.pdf' target='_blank'>Paper</a>
    </div>
  )
}