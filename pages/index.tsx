  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.main}>
        ...
        <p>
          I am a Biomedical Engineering PhD student at the University of Virginia working in the <a href='https://www.papinlab.org/' target='_blank' rel='noopener noreferrer'>Computational Systems Biology Lab</a> under <a href='https://engineering.virginia.edu/faculty/jason-papin' target='_blank' rel='noopener noreferrer'>Dr. Jason Papin</a>. Prior to graduate school, I completed my undergraduate degree in <a href='https://www.wm.edu/as/cams/index.php' target='_blank' rel='noopener noreferrer'>Computational and Applied Mathematics and Statistics (CAMS)</a> at William and Mary in December of 2020.
        </p> 
        <p>
        ...
        <p>
          My graduate research has been funded by the <a href='https://www.nsfgrfp.org/' target='_blank' rel='noopener noreferrer'>NSF Graduate Research Fellowship (GRFP)</a>, <a href='https://engineering.virginia.edu/news/2016/04/nih-t32-training-grant-biomedical-data-sciences' target='_blank' rel='noopener noreferrer'>NIH T32 Biomedical Data Sciences Training Grant</a>, and was awarded the UVA Distinguished Fellowship.
        </p>
